...
function donateFeni() {
  ...
  document.getElementById("btn-2").addEventListener("click", function () {
    //   console.log('ok')
    let inputAmount = getInputValueById("input-2");
    let myBalanceElement = getInnerTextById("my-balance");
    let feniBalanceElement = getInnerTextById("feni-balance");
    let feniBalance = parseFloat(getInnerTextNumberById("feni-balance"));
